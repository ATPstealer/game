...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'BuildingsBankNameId': RouteRecordInfo<'BuildingsBankNameId', '/buildings/bank/:name-:id', { name: ParamValue<true>, id: ParamValue<true> }, { name: ParamValue<false>, id: ParamValue<false> }>,
