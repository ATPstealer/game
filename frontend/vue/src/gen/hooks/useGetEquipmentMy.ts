...
async function getEquipmentMy(params?: GetEquipmentMyQueryParams, config: Partial<RequestConfig> = {}) {
  const res = await client<GetEquipmentMyQueryResponse, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>, unknown>({
    method: 'GET',
    url: '/equipment/my',
    params,
    ...config
...
export function getEquipmentMyQueryOptions(params?: MaybeRef<GetEquipmentMyQueryParams>, config: Partial<RequestConfig> = {}) {
  ...
  return queryOptions<GetEquipmentMyQueryResponse, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>, GetEquipmentMyQueryResponse, typeof queryKey>({
    queryKey,
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<GetEquipmentMyQueryResponse, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>, TData, TQueryData, TQueryKey>>;
  ...
  }) as UseQueryReturnType<TData, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>> & { queryKey: TQueryKey }
