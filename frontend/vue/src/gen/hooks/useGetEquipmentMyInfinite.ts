...
export function getEquipmentMyInfiniteQueryOptions(params?: MaybeRef<GetEquipmentMyQueryParams>, config: Partial<RequestConfig> = {}) {
  ...
  return infiniteQueryOptions<
    GetEquipmentMyQueryResponse,
    ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>,
    GetEquipmentMyQueryResponse,
    typeof queryKey,
    number
  >({
...
>(
  ...
  options: {
    query?: Partial<
      InfiniteQueryObserverOptions<GetEquipmentMyQueryResponse, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>, TData, TQueryData, TQueryKey>
    >;
  ...
  }) as UseInfiniteQueryReturnType<TData, ResponseErrorConfig<GetEquipmentMy401 | GetEquipmentMy500>> & { queryKey: TQueryKey }
