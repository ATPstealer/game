...
export interface CreditTermsWithData {
    buildingId: string;
    limit: number;
    rate: number;
    rating: number;
...
export interface EmergencyHiringPayload {
    buildingId: string;
}
...
export interface TakeCreditPayload {
    amount: number;
    buildingId: string;
    rate: number;
    rating: number;
...
export interface DeleteBankDeleteLoanData {
    query: {
        /**
         * Loan ID
         */
...
export interface PostBankRepayLoanData {
    /**
     * Repay loan payload
     */
...
export interface PostBankTakeCreditData {
    /**
     * Get credit payload
     */
...
export interface PostBankTakeStateCreditData {
    /**
...
export interface PostBuildingEmergencyHiringData {
    /**
