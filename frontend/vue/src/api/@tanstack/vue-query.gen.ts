...
export const postBankCreditTermsMutation = () => {
    const mutationOptions: UseMutationOptions<PostBankCreditTermsResponse, PostBankCreditTermsError, Options<PostBankCreditTermsData>> = {
...
export const postBuildingConstructMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingConstructResponse, PostBuildingConstructError, Options<PostBuildingConstructData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingConstruct({
            ...options,
            throwOnError: true
...
export const deleteBuildingDestroyMutation = () => {
    const mutationOptions: UseMutationOptions<DeleteBuildingDestroyResponse, DeleteBuildingDestroyError, Options<DeleteBuildingDestroyData>> = {
    mutationFn: async (options) => {
...
export const postBuildingEmergencyHiringQueryKey = (options: Options<PostBuildingEmergencyHiringData>) => [
    createQueryKey("postBuildingEmergencyHiring", options)
];

export const postBuildingEmergencyHiringOptions = (options: Options<PostBuildingEmergencyHiringData>) => {
    return queryOptions({
        queryFn: async ({queryKey}) => {
            const {data} = await postBuildingEmergencyHiring({
                ...options,
                ...queryKey[0],
                throwOnError: true
            });
        ...
        queryKey: postBuildingEmergencyHiringQueryKey(options)
    });
};

export const postBuildingEmergencyHiringMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingEmergencyHiringResponse, PostBuildingEmergencyHiringError, Options<PostBuildingEmergencyHiringData>> = {
        mutationFn: async (options) => {
            const {data} = await postBuildingEmergencyHiring({
                ...options,
                throwOnError: true
...
export const postBuildingGetInfiniteQueryKey = (options?: Options<PostBuildingGetData>): QueryKey<Options<PostBuildingGetData>> => [
    createQueryKey("postBuildingGet", options, true)
];

export const postBuildingGetInfiniteOptions = (options?: Options<PostBuildingGetData>) => {
    return infiniteQueryOptions<PostBuildingGetResponse, PostBuildingGetError, InfiniteData<PostBuildingGetResponse>, QueryKey<Options<PostBuildingGetData>>, number | Pick<QueryKey<Options<PostBuildingGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
        {
            queryFn: async ({pageParam, queryKey}) => {
        // @ts-ignore
                const page: Pick<QueryKey<Options<PostBuildingGetData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === "object" ? pageParam : {
                    body: {
                page: pageParam
                    }
                };
...
export const postBuildingGetMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingGetResponse, PostBuildingGetError, Options<PostBuildingGetData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingGet({
            ...options,
            throwOnError: true
...
export const postBuildingHiringMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingHiringResponse, PostBuildingHiringError, Options<PostBuildingHiringData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingHiring({
            ...options,
            throwOnError: true
...
export const postBuildingInstallEquipmentQueryKey = (options: Options<PostBuildingInstallEquipmentData>) => [
    createQueryKey("postBuildingInstallEquipment", options)
];

export const postBuildingInstallEquipmentOptions = (options: Options<PostBuildingInstallEquipmentData>) => {
    return queryOptions({
    queryFn: async ({ queryKey }) => {
...
export const postBuildingInstallEquipmentMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingInstallEquipmentResponse, PostBuildingInstallEquipmentError, Options<PostBuildingInstallEquipmentData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingInstallEquipment({
            ...options,
            throwOnError: true
...
export const postBuildingStartWorkInfiniteQueryKey = (options: Options<PostBuildingStartWorkData>): QueryKey<Options<PostBuildingStartWorkData>> => [
    createQueryKey("postBuildingStartWork", options, true)
];

export const postBuildingStartWorkInfiniteOptions = (options: Options<PostBuildingStartWorkData>) => {
    return infiniteQueryOptions<PostBuildingStartWorkResponse, PostBuildingStartWorkError, InfiniteData<PostBuildingStartWorkResponse>, QueryKey<Options<PostBuildingStartWorkData>>, StartProductionPayload | Pick<QueryKey<Options<PostBuildingStartWorkData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
        {
            queryFn: async ({pageParam, queryKey}) => {
        // @ts-ignore
                const page: Pick<QueryKey<Options<PostBuildingStartWorkData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === "object" ? pageParam : {
                    body: {
...
export const postBuildingStartWorkMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingStartWorkResponse, PostBuildingStartWorkError, Options<PostBuildingStartWorkData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingStartWork({
            ...options,
            throwOnError: true
...
export const postBuildingStopWorkInfiniteQueryKey = (options: Options<PostBuildingStopWorkData>): QueryKey<Options<PostBuildingStopWorkData>> => [
...
export const postBuildingStopWorkInfiniteOptions = (options: Options<PostBuildingStopWorkData>) => {
    return infiniteQueryOptions<PostBuildingStopWorkResponse, PostBuildingStopWorkError, InfiniteData<PostBuildingStopWorkResponse>, QueryKey<Options<PostBuildingStopWorkData>>, StartProductionPayload | Pick<QueryKey<Options<PostBuildingStopWorkData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
        {
            queryFn: async ({pageParam, queryKey}) => {
        // @ts-ignore
                const page: Pick<QueryKey<Options<PostBuildingStopWorkData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === "object" ? pageParam : {
                    body: {
                startWorkPayload: pageParam
                    }
                };
...
export const postBuildingStopWorkMutation = () => {
    const mutationOptions: UseMutationOptions<PostBuildingStopWorkResponse, PostBuildingStopWorkError, Options<PostBuildingStopWorkData>> = {
    mutationFn: async (options) => {
        const {data} = await postBuildingStopWork({
            ...options,
            throwOnError: true
...
export const postLogisticsSetPriceMutation = () => {
    const mutationOptions: UseMutationOptions<PostLogisticsSetPriceResponse, PostLogisticsSetPriceError, Options<PostLogisticsSetPriceData>> = {
    mutationFn: async (options) => {
        const {data} = await postLogisticsSetPrice({
            ...options,
            throwOnError: true
...
export const getMapQueryKey = (options?: Options) => [
    createQueryKey("getMap", options)
];
...
export const postMapBuyLandMutation = () => {
    const mutationOptions: UseMutationOptions<PostMapBuyLandResponse, PostMapBuyLandError, Options<PostMapBuyLandData>> = {
    mutationFn: async (options) => {
        const {data} = await postMapBuyLand({
            ...options,
            throwOnError: true
...
export const getMapMyQueryKey = (options?: Options) => [
    createQueryKey("getMapMy", options)
];
...
export const deleteMarketOrderCloseMutation = () => {
    const mutationOptions: UseMutationOptions<DeleteMarketOrderCloseResponse, DeleteMarketOrderCloseError, Options<DeleteMarketOrderCloseData>> = {
    mutationFn: async (options) => {
...
export const postMarketOrderCreateMutation = () => {
    const mutationOptions: UseMutationOptions<PostMarketOrderCreateResponse, PostMarketOrderCreateError, Options<PostMarketOrderCreateData>> = {
    mutationFn: async (options) => {
        const {data} = await postMarketOrderCreate({
            ...options,
            throwOnError: true
...
export const postMarketOrderExecuteMutation = () => {
    const mutationOptions: UseMutationOptions<PostMarketOrderExecuteResponse, PostMarketOrderExecuteError, Options<PostMarketOrderExecuteData>> = {
    mutationFn: async (options) => {
        const {data} = await postMarketOrderExecute({
            ...options,
            throwOnError: true
...
export const getOrdersInfiniteQueryKey = (options?: Options<GetOrdersData>): QueryKey<Options<GetOrdersData>> => [
    createQueryKey("getOrders", options, true)
];

export const getOrdersInfiniteOptions = (options?: Options<GetOrdersData>) => {
    return infiniteQueryOptions<GetOrdersResponse, GetOrdersError, InfiniteData<GetOrdersResponse>, QueryKey<Options<GetOrdersData>>, number | Pick<QueryKey<Options<GetOrdersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
        {
            queryFn: async ({pageParam, queryKey}) => {
        // @ts-ignore
...
export const postResourceMoveMutation = () => {
    const mutationOptions: UseMutationOptions<PostResourceMoveResponse, PostResourceMoveError, Options<PostResourceMoveData>> = {
    mutationFn: async (options) => {
        const {data} = await postResourceMove({
            ...options,
            throwOnError: true
...
export const getSettingsQueryKey = (options?: Options) => [
...
export const getStorageMyQueryKey = (options?: Options) => [
    createQueryKey("getStorageMy", options)
];
...
export const postStoreGoodsSetMutation = () => {
    const mutationOptions: UseMutationOptions<PostStoreGoodsSetResponse, PostStoreGoodsSetError, Options<PostStoreGoodsSetData>> = {
    mutationFn: async (options) => {
        const {data} = await postStoreGoodsSet({
            ...options,
            throwOnError: true
...
export const postUserCreateMutation = () => {
    const mutationOptions: UseMutationOptions<PostUserCreateResponse, PostUserCreateError, Options<PostUserCreateData>> = {
    mutationFn: async (options) => {
        const {data} = await postUserCreate({
            ...options,
            throwOnError: true
...
export const getUserDataQueryKey = (options?: Options) => [
    createQueryKey("getUserData", options)
];
...
export const postUserLoginMutation = () => {
    const mutationOptions: UseMutationOptions<PostUserLoginResponse, PostUserLoginError, Options<PostUserLoginData>> = {
    mutationFn: async (options) => {
        const {data} = await postUserLogin({
            ...options,
            throwOnError: true
...
export const deleteUserLoginMutation = () => {
    const mutationOptions: UseMutationOptions<DeleteUserLoginResponse, DeleteUserLoginError, Options> = {
    mutationFn: async (options) => {
